                ...
                <table className="table w-[920px] h-[320px]">
                    ...
                    <thead>
                        <tr>
                            ...
                            '>
                                <div className='flex items-center'>
                                    <p className='text-[14px] text-[#383838] font-semibold'>City</p>
                                    <img onClick={handleCity} className='w-[15px] cursor-pointer hover:scale-105 h-[15px] ml-[10px] ' src={upDownIcon} alt="" />
                                </div>
                            </th>
                            <th className='
                            normal-case
                    ...
                    <tbody>
...

                        {
                            ...
                            `}>
                                        <p className='text-[14px]  ml-[10]  font-[400] text-[#383838]'>{user.city}</p>
                                    </td>
                                    <td className={
                                        `
                                         normal-case
